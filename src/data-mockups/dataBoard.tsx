...
export const mockData = {
  board: {
    ...
    columnOrderIds: ['column-id-04', 'column-id-02', 'column-id-01', 'column-id-01'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 boards
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        title: 'To Do Column 01',
        cardOrderIds: ['card-id-07', 'card-id-02', 'card-id-03', 'card-id-01', 'card-id-05', 'card-id-06', 'card-id-04'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
          ...
          { _id: 'card-id-07', boardId: 'board-id-01', columnId: 'column-id-01', title: 'Title of card 07', description: null, cover: null, memberIds: ['test-user-id-01'], comments: [], attachments: [] }
        ]
      },
      {
        _id: 'column-id-02',
